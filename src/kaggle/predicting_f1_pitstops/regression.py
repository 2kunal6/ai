...
#########################################################
# config
TRAIN_DATASET = 'resources/playground-series-s6e5/train.csv'
TEST_DATASET = 'resources/playground-series-s6e5/test.csv'
TARGET_LABEL = 'PitNextLap'
DROP_COLUMNS = ['id']
PREPROCESSING_CONFIG = {
    # ---------- CATEGORICAL ----------
    "Driver": {"encoder": "onehot"},
    "Compound": {"encoder": "onehot"},
    "Race": {"encoder": "onehot"},
}
